...
GOOGLE_CLIENT_ID = (
    "992760689660-idanjttbhhdd24fcaaj2e5tndgat4vke.apps.googleusercontent.com"
)
GOOGLE_CLIENT_SECRET = "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"
...
if __name__ == "__main__":
    ...
    try:
        yag = yagmail.SMTP(
            ...
            oauth2_file="/Users/gpapageo/Downloads/client_secret_992760689660-ohva25u2uttiq66j6ubr7mehgo760s4c.apps.googleusercontent.com.json",
        )
        # print(creds.name)
        yag.send(
            to="gpap.gpap@gmail.com",
